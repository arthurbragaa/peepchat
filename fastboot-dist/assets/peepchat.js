...
define('peepchat/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"peepchat","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"peepchat","version":"0.0.0+0027f4e7"},"exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("peepchat/app")["default"].create({"name":"peepchat","version":"0.0.0+0027f4e7"});
}
